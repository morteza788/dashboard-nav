 ...
 */
   ...
   // Performance Report
    ...
    grid: {
      ...
      xaxis: {
        show: true,
        ticks: [[0,''],[10,'فروردین'],[22,'اردیبهشت'],[34,'خرداد'],[46,'تیر'],[58,'مرداد'],[70,'شهریور'],[82,'مهر'],[94,'آبان'],[106,'آذر'],[118,'دی'],[130,'بهمن'],[142,'اسفند']],
      }
    });
...
var dash_spark_1 = {
  ...
  var options = {
    ...
    labels: [ "ارسال شده", "باز شده", "باز نشده"],
...
colors: ['#2a76f4',"#fdb5c8", ],
  ...
  xaxis: {
    type: 'categories',
    categories: ['شنیه','یک شنبه', 'دو شنبه', 'سه شنیه', 'چهارشنبه', 'پنج شنبه', 'جمعه'],
