! function (a) {
    ...
    a.sessionTimeout = function (b) {
        ...
        function f(b, c) {
            ...
            if (i.countdownSmart) {
                var g = Math.floor(e / 60),
                    h = e % 60,
                    k = g > 0 ? g + "m" : "";
                k.length > 0 && (k += " "), k += h + " ثانیه ", d.text(k)
            } else d.text(e + " ثانیه ");
        ...
        var g, h = {
                title: "سشن شما در حال انقضا است!",
                message: "Your session is about to expire.",
                logoutButton: "خروج",
                keepAliveButton: "وصل ماندن",
